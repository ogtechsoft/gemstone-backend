...
module.exports = function pdfGen(bodyData, id, old_image) {
  return new Promise(async (resolve, reject) => {
    try {
      bodyData.finalImage = `https://api.gemfame.in/media/Certificate/${id}/${
        bodyData.image && bodyData.image != "" ? bodyData.image : old_image
      }`;
